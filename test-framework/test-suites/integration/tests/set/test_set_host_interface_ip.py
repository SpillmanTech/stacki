...
class TestSetHostInterfaceIP:
	def test_set_host_interface_ip_no_hosts(self, host):
	...
	def test_set_host_interface_ip_no_matching_hosts(self, host):
	...
	def test_set_host_interface_ip_no_parameters(self, host):
	...
	def test_set_host_interface_ip_no_selector(self, host):
	...
	def test_set_host_interface_ip_invalid_interface(self, host):
	...
	def test_set_host_interface_ip_invalid_mac(self, host):
	...
	def test_set_host_interface_ip_invalid_network(self, host):
	...
	def test_set_host_interface_ip_invalid_combo(self, host, add_host, add_network):
	...
	def test_set_host_interface_ip_by_network(self, host, add_host, add_network):
		# Add an interface with an interface and network to our test host
		result = host.run('stack add host interface backend-0-0 interface=eth0 network=test')
		assert result.rc == 0
	...
	def test_set_host_interface_ip_by_interface(self, host, add_host_with_interface):
		# Set the host IP address
	...
	def test_set_host_interface_ip_by_mac(self, host, add_host):
	...
	def test_set_host_interface_ip_all_parameters(self, host, add_host, add_network):
	...
	def test_set_host_interface_ip_by_network_with_auto(self, host, add_host):
	...
	def test_set_host_interface_ip_by_interface_with_auto(self, host, add_host):
		# Create a test network with a whole class A block
		result = host.run('stack add network test address=10.0.0.0 mask=255.0.0.0 gateway=10.0.0.1')
		assert result.rc == 0
	...
	def test_set_host_interface_ip_by_mac_with_auto(self, host, add_host):
		# Create a test network with a whole class A block
		result = host.run('stack add network test address=10.0.0.0 mask=255.0.0.0 gateway=10.0.0.1')
		assert result.rc == 0
	...
	def test_set_host_interface_ip_auto_without_network(self, host, add_host):
		# Create a test network with a whole class A block
		result = host.run('stack add network test address=10.0.0.0 mask=255.0.0.0 gateway=10.0.0.1')
		assert result.rc == 0
	...
	def test_set_host_interface_ip_auto_no_more_ips(self, host, add_host):
	...
	def test_set_host_interface_ip_multiple_hosts(self, host, add_host):
