...
class TestSetHostInterfaceMac:
	def test_set_host_interface_mac_no_hosts(self, host):
	...
	def test_set_host_interface_mac_no_matching_hosts(self, host):
	...
	def test_set_host_interface_mac_no_parameters(self, host):
	...
	def test_set_host_interface_mac_no_selector(self, host):
	...
	def test_set_host_interface_mac_invalid_interface(self, host):
	...
	def test_set_host_interface_mac_invalid_network(self, host):
	...
	def test_set_host_interface_mac_invalid_combo(self, host, add_host, add_network):
	...
	def test_set_host_interface_mac_by_network(self, host, add_host, add_network):
	...
	def test_set_host_interface_mac_by_interface(self, host, add_host_with_interface):
		# Set the host interface mac
	...
	def test_set_host_interface_mac_all_parameters(self, host, add_host, add_network):
		# Add an interface with a interface device and network to our test host
		result = host.run('stack add host interface backend-0-0 interface=eth0 network=test')
		assert result.rc == 0
