...
class TestSetHostInterfaceInterface:
	def test_set_host_interface_interface_no_hosts(self, host):
	...
	def test_set_host_interface_interface_no_matching_hosts(self, host):
	...
	def test_set_host_interface_interface_no_parameters(self, host):
	...
	def test_set_host_interface_interface_no_selector(self, host):
	...
	def test_set_host_interface_interface_invalid_mac(self, host):
	...
	def test_set_host_interface_interface_invalid_network(self, host):
	...
	def test_set_host_interface_interface_invalid_combo(self, host, add_host, add_network):
	...
	def test_set_host_interface_interface_by_network(self, host, add_host, add_network):
	...
	def test_set_host_interface_interface_by_mac(self, host, add_host):
	...
	def test_set_host_interface_interface_all_parameters(self, host, add_host, add_network):
		# Add an interface with a mac and network to our test host
		result = host.run('stack add host interface backend-0-0 mac=00:11:22:33:44:55 network=test')
		assert result.rc == 0
	...
	def test_set_host_interface_interface_multiple_hosts(self, host, add_host, add_network):
