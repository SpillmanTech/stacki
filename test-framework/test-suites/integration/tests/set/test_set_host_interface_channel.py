...
class TestSetHostInterfaceChannel:
	...
	def test_set_host_interface_channel_no_selector(self, host):
	...
	def test_set_host_interface_channel_invalid_network(self, host):
	...
	def test_set_host_interface_channel_invalid_combo(self, host, add_host, add_network):
	...
	def test_set_host_interface_channel_by_network(self, host, add_host, add_network):
		# Add an interface with an interface and network to our test host
		result = host.run('stack add host interface backend-0-0 interface=eth0 network=test')
		assert result.rc == 0
	...
	def test_set_host_interface_channel_all_parameters(self, host, add_host, add_network):
