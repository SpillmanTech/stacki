...
class TestSetHostInterfaceDefault:
	def test_set_host_interface_default_no_hosts(self, host):
	...
	def test_set_host_interface_default_no_matching_hosts(self, host):
	...
	def test_set_host_interface_default_no_selector(self, host):
	...
	def test_set_host_interface_default_invalid_interface(self, host):
	...
	def test_set_host_interface_default_invalid_mac(self, host):
	...
	def test_set_host_interface_default_invalid_network(self, host):
	...
	def test_set_host_interface_default_invalid_combo(self, host, add_host, add_network):
	...
	def test_set_host_interface_default_by_network(self, host, add_host, add_network):
		# Add an interface with an interface and network to our test host
		result = host.run('stack add host interface backend-0-0 interface=eth0 network=test')
		assert result.rc == 0
	...
	def test_set_host_interface_default_by_interface(self, host, add_host_with_interface):
		# Set the default host interface
	...
	def test_set_host_interface_default_by_mac(self, host, add_host):
	...
	def test_set_host_interface_default_all_parameters(self, host, add_host, add_network):
	...
	def test_set_host_interface_default_multiple_hosts(self, host, add_host_with_interface):
